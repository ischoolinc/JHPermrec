...
{
    class ContinueStudentUpdateRecordListProvider:INameListProvider 
    {
        //比對大小
        ...
        private string[] _CodeList = new string[] { "8" };
        ...
        public System.Xml.XmlElement CreateNameList(string schoolYear, string semester, List<XmlElement> list)
        {
            ...
            doc.LoadXml("<異動名冊 類別=\"續讀學生名冊\" 學年度=\"" + schoolYear + "\" 學期=\"" + semester + "\" 學校代號=\"" + Framework.Legacy.GlobalOld.SchoolInformation.Code + "\" 學校名稱=\"" + GlobalOld.SchoolInformation.ChineseName + "\"/>");
