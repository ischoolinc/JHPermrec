...
{
    class ImportUpdateRecCode07 : SmartSchool.API.PlugIn.Import.Importer
    {
        public ImportUpdateRecCode07()
        {
            this.Image = null;
            this.Text = "匯入中輟異動";
        }
        ...
        public override void InitializeImport(SmartSchool.API.PlugIn.Import.ImportWizard wizard)
        {
            ...
            wizard.ImportableFields.AddRange("學年度", "學期", "異動年級", "異動日期", "異動原因", "備註", "異動班級", "異動姓名", "異動身分證號", "異動學號", "異動性別", "異動生日", "異動地址", "核准日期", "核准文號", "學籍核准日期", "學籍核准文號", "異動座號", "異動類別", "原因及事項");
                    ...
                    switch (field)
                    {
                        ...
                        case "異動類別":
                            if (value != "中輟")
                            {
                                ...
                                e.ErrorFields.Add(field, "必須填入中輟");
                            }
                            break;
            ...
            wizard.ImportPackage += delegate(object sender, SmartSchool.API.PlugIn.Import.ImportPackageEventArgs e)
            {
                ...
                try
                {
                    ...
                    prlp.SaveLog("學生.匯入異動", "匯入中輟異動", "匯入中輟異動：共新增" + InsertList.Count + "筆資料,共更新:" + UpdateList.Count + "筆資料");
