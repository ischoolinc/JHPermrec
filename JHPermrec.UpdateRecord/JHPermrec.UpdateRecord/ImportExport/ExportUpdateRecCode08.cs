...
{
    // 匯出續讀異動
    class ExportUpdateRecCode08:SmartSchool.API.PlugIn.Export.Exporter
    {
        // 可勾選選項
        List<string> ExportItemList;

        public ExportUpdateRecCode08()
        {
            this.Image = null;
            this.Text = "匯出續讀異動";
        ...
        public override void InitializeExport(SmartSchool.API.PlugIn.Export.ExportWizard wizard)
        {
            ...
            {
                Dictionary<string, List<DAL.StudUpdateRecordEntity>> StudUpdateRecordEntityListDic = DAL.DALTransfer2.GetStudListUpdateRecordEntityListByUpdateType(e.List, JHPermrec.UpdateRecord.DAL.DALTransfer2.UpdateType.續讀);
                int ExportCount = 0;
                        ...
                        foreach (string field in e.ExportFields)
                        {
                            if (wizard.ExportableFields.Contains(field))
                            {
                                ...
                                {                                
                                    ...
                                    case "異動類別": row.Add(field, "續讀"); break;
                                }
                            }
                        }
                        ExportCount++;
                ...
                prlp.SaveLog("學生.匯出異動", "匯出續讀異動", "共匯出續讀異動" + ExportCount + "筆資料.");
            };
