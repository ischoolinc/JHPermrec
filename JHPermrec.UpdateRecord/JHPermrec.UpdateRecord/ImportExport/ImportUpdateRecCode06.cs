...
{
    class ImportUpdateRecCode06 : SmartSchool.API.PlugIn.Import.Importer
    {
        public ImportUpdateRecCode06()
        {
            this.Image = null;
            this.Text = "匯入復學異動";
        }
        ...
        public override void InitializeImport(SmartSchool.API.PlugIn.Import.ImportWizard wizard)
        {
                    ...
                    switch (field)
                    {
                        ...
                        case "異動類別":
                            if (value != "復學")
                            {
                                ...
                                e.ErrorFields.Add(field, "必須填入復學");
                            }
                            break;
            ...
            wizard.ImportPackage += delegate(object sender, SmartSchool.API.PlugIn.Import.ImportPackageEventArgs e)
            {
                ...
                try
                {
                    ...
                    prlp.SaveLog("學生.匯入異動", "匯入復學異動", "匯入復學異動：共新增" + InsertList.Count + "筆資料,共更新:" + UpdateList.Count + "筆資料");
