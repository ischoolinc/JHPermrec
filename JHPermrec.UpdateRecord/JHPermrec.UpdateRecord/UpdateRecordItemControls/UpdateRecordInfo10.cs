...
{
    // 延長修業年限
    public partial class UpdateRecordInfo10 : UserControl,IUpdateRecordInfo 
    {
        ...
        private void GetUpdateReocrdInfoFromForm()
        {
            ...
            _StudUpdateRecordEntity.SetUpdateCode("10");
        ...
        private string updateConfigKey = "UpdateReasons10";   //紀錄異動原因清單的組態值的Key
