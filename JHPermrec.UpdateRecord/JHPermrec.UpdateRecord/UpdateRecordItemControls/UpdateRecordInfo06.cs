...
{
    // 復學異動
    public partial class UpdateRecordInfo06 : UserControl,IUpdateRecordInfo 
    {
        ...
        private void GetUpdateReocrdInfoFromForm()
        {
            ...
            _StudUpdateRecordEntity.SetUpdateCode("6");
        ...
        public UpdateRecordInfo06(DAL.StudUpdateRecordEntity sure)
        {
            InitializeComponent();
