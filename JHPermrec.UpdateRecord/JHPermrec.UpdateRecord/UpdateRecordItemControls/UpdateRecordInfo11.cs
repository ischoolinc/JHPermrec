...
{
    // 死亡
    public partial class UpdateRecordInfo11 : UserControl,IUpdateRecordInfo 
    {
        ...
        private void GetUpdateReocrdInfoFromForm()
        {
            ...
            _StudUpdateRecordEntity.SetUpdateCode("11");
        ...
        private string updateConfigKey = "UpdateReasons11";   //紀錄異動原因清單的組態值的Key
        private string ExtendingConfigKey = "ExtendingReason11";    //紀錄中輟原因清單的組態值的Key
        //將中輟紀錄清單的key輸入至list cd中


        public UpdateRecordInfo11(DAL.StudUpdateRecordEntity sure)
        {
            InitializeComponent();
            ...
            {
                cd[ExtendingConfigKey] = "因病;意外;其它";
                cd.Save();
            ...
            foreach (string defaultreason in new string[] { "因病", "意外", "其它" })
            {
