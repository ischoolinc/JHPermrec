...
{
    public partial class BatchAddNewStudUpdateRecord_Warning :FISCA.Presentation.Controls.BaseForm
    {
        ...
        public BatchAddNewStudUpdateRecord_Warning()
        {
            InitializeComponent();
        }
        ...
        private void btnExportXls_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                wb.Save(Application.StartupPath + "\\Reports\\已有新生異動.xls", FileFormatType.Excel2003);
                System.Diagnostics.Process.Start(Application.StartupPath + "\\Reports\\已有新生異動.xls");
        ...
        private void BatchAddNewStudUpdateRecord_Warning_Load(object sender, EventArgs e)
        {
            lblMsg.Text = "有" + this._DataCount.ToString() + "名學生已有新生異動。";
        }
    }
}
