...
namespace JHSchool.Permrec.StudentExtendControls.Reports
{
    class StudentIDCardManager
    {
        ...
        private static int _photo_inch = 0;
        ...
        public StudentIDCardManager()
        {
            ...
            {
                defalutTemplate = JHSchool.Permrec.StudentExtendControls.Reports.RptResource.學生證樣板_新竹_New;
                // 寫法用高雄
                UseCountyType = CountyType.高雄;
