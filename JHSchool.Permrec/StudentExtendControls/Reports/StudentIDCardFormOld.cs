...
{
    public partial class StudentIDCardFormOld : FISCA.Presentation.Controls.BaseForm 
    {
        StudentIDCardManagerOld sidm;
        ...
        public StudentIDCardFormOld(UseModuleType UseModule)
        {
            InitializeComponent();
            sidm = new StudentIDCardManagerOld();
