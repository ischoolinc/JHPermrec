...
{
    [FeatureCode("Content0200", "自訂資料欄位")]
    public partial class ExtensionValuesPalmerwormItem : JHSchool.Permrec.Legacy.PalmerwormItem
    {
        ...
        public ExtensionValuesPalmerwormItem()
        {
            ...
            _BKW.DoWork += delegate
            {
                ...
                //}
                //DSResponse resp = SeniorHSBase.Feature.Legacy.QueryStudent.GetExtension("", new string[0], new string[] { _RunningID });
        ...
        public override void Save()
        {
            ...
            try
            {
                ...
                foreach ( DataGridViewRow row in dataGridViewEx1.Rows )
                {
                    ...
                    {
                        items[_CurrentID] = v;
                        JHSchool.Feature.Legacy.EditStudent.SetExtend("", k, items);
                ...
                {
                    JHSchool.Feature.Legacy.EditStudent.SetExtend("", removeKey, items);
        ...
        {
            if ( new JHSchool.Legacy.ExtensionTemplateSetup().ShowDialog() == DialogResult.OK && this.CancelButtonVisible == false )
            {
                LoadContent(_CurrentID);
            }
        }
