...
//    {
//        private List<DAL.StudPhotoEntity> _StudPhotoEntityList;

//        public PhotoCompleteMessage()
//        {
//            InitializeComponent();
//            _StudPhotoEntityList = new List<JHSchool.Permrec.StudentExtendControls.PhotosBatchImportExports.DAL.StudPhotoEntity>();
//        }


//        public void SetStudPhotoEntity(List<DAL.StudPhotoEntity> StudPhotoEntityList1)
//        {
...
//            wst.Cells[0, 2].PutValue("座號");
//            wst.Cells[0, 3].PutValue("姓名");
//            wst.Cells[0, 4].PutValue("錯誤訊息");

//            int row = 1;
//            foreach (DAL.StudPhotoEntity spe in _StudPhotoEntityList)
//            {
//                wst.Cells[row, 0].PutValue(spe.StudentNumber);
//                wst.Cells[row, 1].PutValue(spe.ClassName);
//                wst.Cells[row, 2].PutValue(spe.SeatNo);
//                wst.Cells[row, 3].PutValue(spe.StudentName);
//                wst.Cells[row, 4].PutValue(spe.ErrorMessage);
//                row++;
//            }
