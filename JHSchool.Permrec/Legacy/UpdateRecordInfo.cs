...
namespace JHSchool.Permrec.Legacy
{
    ...
    public partial class UpdateRecordInfo : UserControl
    {
        ...
        private void _BWDepartmentCode_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            e.Result = Framework.Feature.Config.GetDepartment().GetContent().GetElements("Department");
        }

        //NewData
        private NewDataField _newData = null;
        private NewDataField NewData { get { return _newData; } }
        ...
        private void InitialDict()
        {
            ...
            //StudentExtendControls.UpdateRecordItemForm f1 = new JHSchool.Permrec.StudentExtendControls.UpdateRecordItemForm();
            //f1.ShowDialog();
        }
        ...
        public void SetValue(string tagName, string value, bool showError)
        {
            ...
            if (tagName == "UpdateCode")
            {
                if (GetUpdateCodeSynopsis(_Style.ToString()).ContainsKey(value) && GetValue("UpdateDescription") != GetUpdateCodeSynopsis(_Style.ToString())[value])
                {
                    ...
                    NewData.ChangeNewDataText(value);
                }
            }
            //更新相同tagName控制項的值
        ...
        public UpdateRecordInfo()
        {
            ...
            InitialDict();
            _newData = new NewDataField(lblNewData, txtNewData);
        }
