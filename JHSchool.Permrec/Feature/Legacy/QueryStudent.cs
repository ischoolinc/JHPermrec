...
namespace JHSchool.Permrec.Feature.Legacy
{
    ...
    public class QueryStudent 
    {
        ...
        public static DSResponse SearchStudent(string key, int pageSize, int startPage, bool _SearchInStudentID, bool _SearchInSSN, bool _SearchInName, params string[] _StatusList)
        {
            ...
            return FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.GetAbstractListWithTag", dsreq);
        }
        ...
        public static DSResponse GetExtension(string nameSpace, string[] fields, string[] studentIDs)
        {
            ...
            DSResponse dsrsp = FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.GetExtend", dsreq);
            return dsrsp;
        }
        ...
        public static DSResponse GetDetailList(IEnumerable<string> fields, params string[] list)
        {
            ...
            dsreq.SetContent(helper);
            return FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.GetDetailList", dsreq);
        }
        ...
        public static DSResponse GetAbstractList()
        {
            ...
            helper.AddElement("Order", "SeatNo");
            dsreq.SetContent(helper);
            DSResponse dsrsp = FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.GetAbstractListWithTag", dsreq);
        ...
        public static DSXmlHelper GetAbstractList(params string[] gradeYear)
        {
            ...
            dsreq.SetContent(helper);
            DSResponse dsrsp = FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.GetAbstractList", dsreq);
        ...
        {
            return FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.BulkProcess.Export", request);
        }
        ...
        public static XmlNode GetClassInfo(string studentid)
        {
            ...
            dsreq.SetContent(helper);
            return FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.GetClassInfo", dsreq).GetContent().BaseElement;
        }
        ...
        public static DSResponse GetPhoneDetail(string id)
        {
            ...
            helper.AddElement("Condition", "ID", id);
            dsreq.SetContent(helper);
            return FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.GetAbstractList", dsreq);
        }
        ...
        public static DSResponse GetParentInfo(params  string[] idlist)
        {
            ...
            dsreq.SetContent(helper);
            return FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.GetParentInfo", dsreq);
        }
        ...
        public static DSResponse GetMultiParentInfo(params string[] idlist)
        {
            ...
            dsreq.SetContent(helper);
            return FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.GetMultiParentInfo", dsreq);
        }
        ...
        public static DSResponse GetUpdateInfoList(string RunningID)
        {
            ...
            DSRequest dsreq = new DSRequest(helper);
            return FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.UpdateRecord.GetDetailList", dsreq);
        }
        ...
        {
            return FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.UpdateRecord.GetDetailList", req);
        }
        ...
        public static DSResponse GetSchoolYearList()
        {
            ...
            //return FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.UpdateRecord.GetSchoolYearList", new DSRequest(helper));
        }
        ...
        public static DSResponse GetUpdateRecordBatch(string id)
        {
            ...
            helper.AddElement("Condition");
            helper.AddElement("Condition", "ID", id);
            return FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.UpdateRecord.GetBatchDetailList", new DSRequest(helper));
        }
        ...
        public static bool IDNumberExists(string identity, string idNumber)
        {
            ...
            DSXmlHelper response = FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.GetDetailList", new DSRequest(helper)).GetContent();
        ...
        public static bool LoginIDExists(string loginID, string RunningID)
        {
            ...
            DSResponse dsrsp = FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.GetDetailList", new DSRequest(helper));
        ...
        {
            return FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.GetStudentExamScore", dSRequest);
        }

        public static DSResponse GetStudentMajorCourse(DSRequest dSRequest)
        {
            return FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.GetMajorCourse", dSRequest);
        }
        ...
        public static DSResponse GetDetailListByClassID(params string[] classId)
        {
            ...
            DSRequest dsreq = new DSRequest(helper);
            DSResponse dsrsp = FISCA.Authentication.DSAServices.CallService("SmartSchool.Student.GetDetailList", dsreq);
            return dsrsp;
        }
