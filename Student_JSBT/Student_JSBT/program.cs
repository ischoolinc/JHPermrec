...
namespace Student_JSBT
{
    public class program
    {
        ...
        { 
            ...
            rbiEducationData["產生學生基本學力資料"].Enable = User.Acl["JHSchool.Student.Student_JSBT"].Executable;
            rbiEducationData["產生學生基本學力資料"].Click += delegate
            {
            ...
            catalog.Add(new RibbonFeature("JHSchool.Student.Student_JSBT", "產生學生基本學力資料"));
        }
    }
}
